...
const takeBill = () => {
	const billValue = Number(billAmountInput.value);
	const cashValue = Number(cashAmountInput.value);
	console.log(billValue)
	if(billValue === billAmt[0]) {
		console.log("this part is working!")
	} else {	
		billAmt.push(billValue);
		console.log(billAmt);
...
const takeCash = () => {
	...
	console.log(cashAmt);
	if(cashAmountInput.value < billAmountInput.value) {
